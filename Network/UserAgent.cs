...
namespace Imprint.Network
{
	public class UserAgent
	{
		...
		private static RandomPicker<string> pcPicker;

		private static RandomPicker<string> mobPicker;

		public static string PC => pcPicker.Pick();

		public static string Mobile => mobPicker.Pick();
